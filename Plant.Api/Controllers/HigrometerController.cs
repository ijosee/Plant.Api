...
using Plant.Api.Entities.Rq.Higrometer;
using Plant.Api.Entities.Rs.Higrometer;
...
namespace Plant.Api.Controllers {
    ...
    public class HigrometerController : ControllerBase {
        ...
        [HttpPost]
        public IActionResult Post ([FromBody] HigrometerLogRq request) {
        ...
        [HttpPost]
        [Route ("GetDataTable")]
        public ActionResult<HigrometerDataTableRs> GetDataTable (HigrometerDataTableRq request) {
