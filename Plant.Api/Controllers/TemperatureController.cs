...
using Plant.Api.Entities.Rq.Temperature;
using Plant.Api.Entities.Rs.Temperature;
...
namespace Plant.Api.Controllers {
    ...
    public class TemperatureController : ControllerBase {
        ...
        public TemperatureController (ILogger<TemperatureController> logger, IAppSettings appSettings) {
            _logger = logger;
        ...
        [HttpPost]
        public IActionResult Post ([FromBody] TemperatureLogRq request) {
            ...
            try {
                ...
                using (MySqlConnection connection = new MySqlConnection (_appSettings.GetDataBaseConnectionString ())) {
                    ...
                    var query = $"INSERT INTO " +
                        $"TEMPERATURE_LOGS(`value`,`timestamp`) " +
                        $"VALUES (@value,@date)";
        ...
        public IActionResult Delete (int id) {
            ...
            try {
                ...
                using (MySqlConnection connection = new MySqlConnection (_appSettings.GetDataBaseConnectionString ())) {
                    ...
                    connection.Open ();
                    var query = $"DELETE FROM TEMPERATURE_LOGS WHERE id = @id ";
        ...
        [HttpGet]
        [Route ("GetChart")]
        public ActionResult<IEnumerable<ChartModel>> GetChartTemperatureData (DateTime from, DateTime to) {
            ...
            try {
                ...
                using (MySqlConnection connection = new MySqlConnection (_appSettings.GetDataBaseConnectionString ())) {
                    ...
                    var query = $"SELECT * FROM TEMPERATURE_LOGS WHERE 1=1 ";
